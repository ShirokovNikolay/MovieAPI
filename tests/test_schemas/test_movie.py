...
class TestMovieBaseCreateUpdateResponseSchema:
    ...
    def test_movie_schema_without_name_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_without_description_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_without_rating_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_without_preview_url_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_without_source_url_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_without_genre_id_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_without_release_date_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_with_too_short_name_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_with_too_long_name_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_with_too_long_description_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_with_too_small_rating_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
    ...
    def test_movie_schema_with_too_large_rating_field(
        self,
        schema,
        movie_response_data: dict[str, str | int],
    ) -> None:
...
class TestMoviePartialUpdateSchema:
    def test_movie_partial_update_schema(
        self,
    ...
    def test_movie_partial_update_schema_is_empty(self):
    ...
    def test_movie_partial_update_schema_with_too_short_name_field(
        self,
    ...
    def test_movie_partial_update_schema_with_too_long_name_field(
        self,
        movie_data: dict[str, str | int | datetime],
    ) -> None:
    ...
    def test_movie_partial_update_schema_with_too_long_description_field(
        self,
        movie_data: dict[str, str | int | datetime],
    ) -> None:
    ...
    def test_movie_partial_update_schema_with_too_small_rating_field(
        self,
        movie_data: dict[str, str | int | datetime],
    ) -> None:
    ...
    def test_movie_partial_update_schema_with_too_large_rating_field(
        self,
        movie_data: dict[str, str | int | datetime],
    ) -> None:
...
class TestMovieResponseList:
    def test_movie_response_list_schema(
        self,
